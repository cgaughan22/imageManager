        ...
        function render(data) {
            ...
            if (scannedFiles.length) {
                ...
                scannedFiles.forEach(function(f) {
                    ...
                    var file = $('<li class="files"><a href="' + f.path + '" title="' + f.path + '" class="files">' + icon + '<span id="'+name+'" class="name">' + name + '</span> <span class="details">' + fileSize + '</span></a><i class="fa fa-times close-thick" onclick=\'delFile("'+name.trim()+'")\' aria-hidden="true"></i></li>');
